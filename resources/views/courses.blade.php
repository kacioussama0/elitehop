                                   ...
                                   <div class="card position-relative border-0 ">
                                       ...
                                       <div class="card-body px-5 py-3">
                                           ...
                                           <div class="d-flex align-items-center mb-3">
                                               ...
                                               <div class="me-3 rounded-circle bg-primary-subtle d-flex justify-content-center align-items-center overflow-hidden" style="border: 1px solid var(--bs-primary);width: 190px;height: 190px">
                                               ...
                                               <div class="flex-grow-1">
                                                   ...
                                                   <div class="specifications w-100 align-items-center d-flex justify-content-between">
                                                       ...
                                                       <span class="text-dark fw-bold me-5">
                                                       ...
                                                       <span class="flex-1">
                                                            @if($course->status == 'open' && \Illuminate\Support\Facades\Auth::check())

                                                                        <a href="{{url('/courses/' . $course->slug)}}"  class="btn btn-success">الدخول للدروس</a>

                                                           @elseif($course->status == 'open')
                                                                   <form action="{{url('/create-order/' . $course->slug)}}" method="POST">
                                                                        @csrf
                                                                        <a href="#" onclick="event.preventDefault();this.closest('form').submit();" class="btn btn-outline-success">إشترك الأن</a>
                                                                    </form>
                                                           @elseif($course->status == 'closed')
                                                               <a href="#" class="btn btn-outline-danger">التسجيل مغلق</a>

                                                           @elseif($course->status == 'soon')
                                                               <a href="#" class="btn btn-outline-warning">قريبا</a>
